	...
	<header class="navbar clearfix" id="header">
		<div class="container">
				...
				<#list courses as course>  
					<li class="dropdown">
						<a href="javascript:void(0)" onclick="switchCurriculum(${course.sn})" class="dropdown-toggle" data-toggle="dropdown">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown user" id="header-user">
						...
						<ul class="dropdown-menu">
							...
							<#else>
							<li><a href="/login"><i class="fa fa-power-off"></i>登陆</a></li>
							</#if>
						</ul>
					</li>
					...
					<div class="sidebar-menu nav-collapse">
						...
						<ul>							
							<li class="has-sub">
								...
								<ul class="sub">
									<li><a class="" href="/intro?sn=${curCourse.sn!1}"><span class="sub-menu-text">简介</span></a></li>									
									<li><a class="" href="/teachers?sn=${curCourse.sn!1}"><span class="sub-menu-text">教师队伍</span></a></li>
									<li><a class="" href="/introedit?sn=${curCourse.sn!1}"><span class="sub-menu-text">教学大纲</span></a></li>
							...
							<li class="has-sub">
								...
								<ul class="sub">
									<li><a class="" href="/download?sn=${curCourse.sn!1}"><span class="sub-menu-text">教学课件</span></a></li>
									<li><a class="" href="/download?sn=${curCourse.sn!1}"><span class="sub-menu-text">教学教案</span></a></li>
									<li><a class="" href="/download?sn=${curCourse.sn!1}"><span class="sub-menu-text">教学视频</span></a></li>
									<li><a class="" href="/download?sn=${curCourse.sn!1}"><span class="sub-menu-text">实验指导</span></a></li>
									<#if curUser??>
									<li><a class="" href="/resedit?sn=${curCourse.sn!1}"><span class="sub-menu-text">资源管理</span></a></li>
									</#if>
								</ul>
							</li>
							<li class="has-sub">
								...
								<ul class="sub">
									<li><a class="" href="/resedit2?sn=${curCourse.sn!1}"><span class="sub-menu-text">交作业</span></a></li>
									<li><a class="" href="/homework?sn=${curCourse.sn!1}"><span class="sub-menu-text">上交记录</span></a></li>
									<li><a class="" href="/homework2?sn=${curCourse.sn!1}"><span class="sub-menu-text">考核</span></a></li>									
								</ul>
							</li>							
							<li class="has-sub">
								<a href="javascript:;" class="">
