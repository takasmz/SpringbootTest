...
<#macro pageShow _totalPageNum _currentPageNo _pageName _pageSize=15 _styleClassName="gray"  _defaultPageParameter="p" >

    <#local _maxShowNums = _totalPageNum>
    <#-- 本段默认起始页 -->
    ...
    <#local _htmlNoLinkLine>
        ...
        <#if _currentPageNo != _pageStartNo>
            ...
            <#local _currentPageNo = _currentPageNo - 1 />
        </#if>
        ...
        <a href = "${_pageName}?${_defaultPageParameter}=${_lastPageNo}" target = "_self">末页</a>
         <#local _currentPageNo = _totalPageNum />
